...
This repository does not distribute SoundFont banks. Download any compatible
`.sf2` or `.sf3` bank and place it in this directory, or use a `soundfonts`
directory beside the game executable/AppImage.

Suggested downloads:

- GeneralUser GS: https://github.com/mrbumpy409/GeneralUser-GS/raw/refs/heads/main/GeneralUser-GS.sf2
